...
execute as @e[tag=teleport2] at @s run summon interaction ~ ~ ~ {width:1f,height:2f,response:1b,Tags:["teleport"]}
execute as @e[tag=teleport2] run kill @s
execute at @e[nbt={Item:{tag:{kill:1b}}}] as @e[tag=teleport,dx=0,limit=1] run kill @s
