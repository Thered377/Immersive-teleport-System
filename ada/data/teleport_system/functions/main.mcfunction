...
execute as @a[scores={.xTPS=..-1},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.xw int 1 run scoreboard players get @s .xTPS
execute as @a[scores={.xTPS=1..},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.xw int 1 run scoreboard players get @s .xTPS
execute as @a[scores={.yTPS=..-1},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.yw int 1 run scoreboard players get @s .yTPS
execute as @a[scores={.yTPS=1..},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.yw int 1 run scoreboard players get @s .yTPS
execute as @a[scores={.zTPS=..-1},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.zw int 1 run scoreboard players get @s .zTPS
execute as @a[scores={.zTPS=1..},nbt={SelectedItem:{id:"minecraft:writable_book",tag:{teleport:2b}}}] store result entity @s SelectedItem.tag.zw int 1 run scoreboard players get @s .zTPS
